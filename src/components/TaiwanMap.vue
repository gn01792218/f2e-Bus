<template>
 <div id="map" class="mapContainer position-relative mb-3">
     <div class="island position-absolute">
        <div class="langjon text-center" @click="toCity('LienchiangCounty')">連江</div>
...
export default defineComponent({
    ...
    setup(){
        ...
        d3.json("/taiwan.json",(error:any,geometry:any)=>{
            ...
            .on('click',(d:any) => {
                store.commit('setCurrentCity',d.properties.COUNTYENG.split(" ")[0])
                store.commit('busRoute/getCityBusRoute',d.properties.COUNTYENG.split(" ")[0]) //請求該縣市路線資料
